...
<head>
    ...
    <style>
        .linearIncreaseCell .linearIncreaseCellOne {
            background: #48494B;
            color: white;
        }
        .linearIncreaseCell .linearIncreaseCellTwo {
            background: #ECECEC;
        }
        .linearIncreaseCell .linearIncreaseCellTwo input {
...
<body>
    <div class="section" style="position : relative !important;left: 12rem !important;">
        <form action="" method="POST">
    <table class="table1" border="1" style="padding : 1rem;gap : 1rem;">
        ...
        <tr style="padding-left : 30rem;">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">1</td> -->
            <th style="background: #ECECEC;box-shadow: 2px 4px 5px 4px #82868E;font-size:20px;position : relative; left : 140px !important;height : 3rem !important" colspan="3">LINER</th>
            <!-- <tr></tr> -->
        </tr>
        <tr>
            <td colspan="2"></td>
        ...
        <tr class="linearIncreaseCell">
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">2</td> -->
            <td class="linearIncreaseCellOne">Increase</td>
            <td class="linearIncreaseCellTwo"><input type="text" name="linerb2" id="" value="<?php if(isset($_REQUEST['linerb2'])){ echo $_REQUEST['linerb2'] ;} ?>">%</td>
            <td colspan="2"></td>
        </tr>
        <tr class="linearDate">
        ...
        <tr class="linearTableData">
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">5</td> -->
            <td style="background: #48494B;color:white;">elastomeric 1"</td>
        ...
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">6</td> -->
            <td style="background: #48494B;color:white;">elastomeric 1.5"</td>
        ...
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">7</td> -->
            <td style="background: #48494B;color:white;">elastomeric 2"</td>
        ...
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">10</td> -->
            <td style="background: #48494B;color:white;">Rigid R300 1"</td>
        ...
        <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">11</td> -->
            <td style="background: #48494B;color:white;">Rigid R300 2"</td>
