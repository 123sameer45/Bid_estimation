...
$cascok8 = round(((floatval($_REQUEST['cascok7']) / $cascok6) * 100), 2) ;
$cascol8 = round(((floatval($_REQUEST['cascol7']) / $cascol6) * 100), 2) ;
...
$cascok10 = floatval($_REQUEST['cascob10']) * floatval($_REQUEST['cascok4']) ;
$cascol10 = floatval($_REQUEST['cascob10']) * floatval($_REQUEST['cascol4']) ;
...
$cascok12 = round(((floatval($_REQUEST['cascok11']) / $cascok10) * 100), 2) ;
$cascol12 = round(((floatval($_REQUEST['cascol11']) / $cascol10) * 100), 2) ;
...
$cascoc28 = ($cascoc26 * floatval($_REQUEST['cascoc11'])) / 100 ;
$cascod28 = ($cascod26 * floatval($_REQUEST['cascod11'])) / 100 ;
$cascoe28 = ($cascoe26 * floatval($_REQUEST['cascoe11'])) / 100 ;
$cascof28 = ($cascof26 * floatval($_REQUEST['cascof11'])) / 100 ;
$cascog28 = ($cascog26 * floatval($_REQUEST['cascog11'])) / 100 ;
$cascoh28 = ($cascoh26 * floatval($_REQUEST['cascoh11'])) / 100 ;
$cascoi28 = ($cascoi26 * floatval($_REQUEST['cascoi11'])) / 100 ;
$cascoj28 = ($cascoj26 * floatval($_REQUEST['cascoj11'])) / 100 ;
$cascok28 = ($cascok26 * floatval($_REQUEST['cascok11'])) / 100 ;
$cascol28 = ($cascol26 * floatval($_REQUEST['cascol11'])) / 100 ;
...
$cascoc36 = round(($cascoc28 / $cascoc34) * 100, 2) ;
$cascod36 = round(($cascod28 / $cascod34) * 100, 2) ;
$cascoe36 = round(($cascoe28 / $cascoe34) * 100, 2) ;
$cascof36 = round(($cascof28 / $cascof34) * 100, 2) ;
$cascog36 = round(($cascog28 / $cascog34) * 100, 2) ;
$cascoh36 = round(($cascoh28 / $cascoh34) * 100, 2) ;
$cascoi36 = round(($cascoi28 / $cascoi34) * 100, 2) ;
$cascoj36 = round(($cascoj28 / $cascoj34) * 100, 2) ;
$cascok36 = round(($cascok28 / $cascok34) * 100, 2) ;
$cascol36 = round(($cascol28 / $cascol34) * 100, 2) ;
...
<body>
    ...
    <table class="table1" border="1" >
        ...
        <tr style="background: #48494B; color: white;">
            <!-- <td style="position: sticky; left:0%;  color: #48494B; ">3</td> -->
            <td class="cascoDataHeading" >Round/Spiral</td>
            <td></td>
            <td>8"</td>
            <td>10"</td>
            <td>12"</td>
        ...
        <tr class="cascoData">
            ...
            <td class="cascoDataHeading"   >Casco old pricing</td>
            <td></td>
        ...
        <tr class="cascoData">
            ...
            <td class="cascoDataHeading"   >None Coated Mult</td>
        ...
        <tr class="cascoData">
            ...
            <td class="cascoDataHeading"  >New none Coated Price</td>
            <td></td>
        ...
        <td class="cascoDataHeading"  >New Multiplier %</td>
        <td></td>
        <td><input type="text" name="cascoc8" id="" readonly value="<?php if (isset($cascoc8)){ echo $cascoc8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascod8" id="" readonly value="<?php if (isset($cascod8)){ echo $cascod8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascoe8" id="" readonly value="<?php if (isset($cascoe8)){ echo $cascoe8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascof8" id="" readonly value="<?php if (isset($cascof8)){ echo $cascof8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascog8" id="" readonly value="<?php if (isset($cascog8)){ echo $cascog8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascoh8" id="" readonly value="<?php if (isset($cascoh8)){ echo $cascoh8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascoi8" id="" readonly value="<?php if (isset($cascoi8)){ echo $cascoi8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascoj8" id="" readonly value="<?php if (isset($cascoj8)){ echo $cascoj8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascok8" id="" readonly value="<?php if (isset($cascok8)){ echo $cascok8;} else{ echo 0 ;} ?>"></td>
        <td><input type="text" name="cascol8" id="" readonly value="<?php if (isset($cascol8)){ echo $cascol8;} else{ echo 0 ;} ?>"></td>
        <td></td>
        <td></td>
        </tr>
        <tr class="cascoData">
        ...
        <td class="cascoDataHeading"  >Coated Mult</td>
        ...
        <td class="cascoDataHeading"  >New coated Price</td>
        <td></td>
        ...
        <tr class="cascoData">
            ...
            <td class="cascoDataHeading"  >PDI</td>
        ...
        <tr class="cascoData">
            ...
            <td class="cascoDataHeading"  >West Tech</td>
        ...
        <tr class="cascoDatas">
            ...
            <td class="cascoDataHeading"  >Circle Lined</td>
            <td>6"</td>
            <td>8"</td>
            <td>10"</td>
            <td>12"</td>
        ...
        <td class="cascoDataHeading" >West Tech Current Sheet</td>
        ...
        <td class="cascoDataHeading"  >Where we are at now %</td>
        <td></td>
        ...
        <td></td>
        <td><input type="text" name="cascon22" id="" readonly value="<?php if (isset($cascon22)){ echo $cascon22 ;} else{ echo 0 ;} ?>"></td>
        </tr>
        <tr class="cascoData">
        <!-- <td style="position: sticky; left:0%; background-color: white; ">23</td> -->
        <td class="cascoDataHeading"  >% with PDI</td>
        <td></td>
        ...
        <td class="cascoDataHeading"  >Where we should be %</td>
        <td></td>
        ...
        <td class="cascoDataHeading"  >$$ for west tech mech sheet</td>
        <td></td>
        ...
        <td class="cascoDataHeading"  >New Multiplier on the estimate sheet</td>
        <td></td>
