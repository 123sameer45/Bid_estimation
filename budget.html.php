...
if(isset($_POST['budgetsubmit'])){
    ...
    $budgetc11 = (isset($_SESSION['estimatei91']) ? $_SESSION['estimatei91'] : 0) -
    ...
    $budgetc61 = array_sum([
        ...
        $_REQUEST['budgetc10'] ,floatval($budgetc11) , floatval($_REQUEST['budgetc12']),
...
$data = [
    ...
    'C10' => $_REQUEST['budgetc10'],
    'C11' => isset($_SESSION['budgetc11']) ? $_SESSION['budgetc11'] : '-',
...
<body>
    ...
    <table class="table_1" >
        ...
        <tr style="position:sticky;top:5%;background-color:#48494B;color : white;">
        ...
        <tr>
            ...
            <td><input type="text" name="budgetc10" class="custom-input" value="<?php  if(isset($_REQUEST['budgetc10'])){ echo $_REQUEST['budgetc10'] ; } ?>"></td>
        ...
        <tr>
            ...
            <td><input type="text"  name="budgetc11" class="custom-input" readonly value="<?php  if(isset($budgetc11)){ echo $budgetc11 ; } ?>"></td>
