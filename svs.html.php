...
if(isset($_REQUEST['svssubmit'])){
    ...
    $svsc2 = isset($_SESSION['estimateg8']) ? $_SESSION['estimateg8'] : '-';
    $svse2 = isset($_SESSION['estimateg13']) ? $_SESSION['estimateg13'] : '-';
    $svsg2 = isset($_SESSION['estimateg17']) ? $_SESSION['estimateg17'] : '-';
    $svsi2 = isset($_SESSION['estimateg14']) ? $_SESSION['estimateg14'] : '-';
    $svsk2 = isset($_SESSION['estimateg34']) ? $_SESSION['estimateg34'] : '-';
    $svsm2 = isset($_SESSION['estimateg40']) ? $_SESSION['estimateg40'] : '-';
    $svso2 = isset($_SESSION['estimateg24']) ? $_SESSION['estimateg24'] : '-';
    $svsq2 = isset($_SESSION['estimateg29']) ? $_SESSION['estimateg29'] : '-';
    $svss2 = isset($_SESSION['estimateg31']) ? $_SESSION['estimateg31'] : '-';
    $svsv2 = array_sum([isset($_SESSION['estimateg25']) ? $_SESSION['estimateg25'] : '-',
                       isset($_SESSION['estimateg26']) ? $_SESSION['estimateg26'] : '-',
                       isset($_SESSION['estimateg27']) ? $_SESSION['estimateg27'] : '-']);
    
    $svsx2 = isset($_SESSION['estimatej69']) ? $_SESSION['estimatej69'] : '-';
    $svsz2 = isset($_SESSION['estimatej56']) ? $_SESSION['estimatej56'] : '-';
    $svsab2 = isset($_SESSION['estimatej28']) ? $_SESSION['estimatej28'] : '-';-
    $svsad2 = floatval(isset($_SESSION['estimatej57']) ? $_SESSION['estimatej57'] : '-');
    $svsaf2 = isset($_SESSION['estimatej59']) ? $_SESSION['estimatej59'] : '-';
    $svsai2 = array_sum([isset($_SESSION['estimatec2']) ? $_SESSION['estimatec2'] : '-',
                         isset($_SESSION['estimated2']) ? $_SESSION['estimated2'] : '-',
                         isset($_SESSION['estimatee2']) ? $_SESSION['estimatee2'] : '-',
                         isset($_SESSION['estimatef2']) ? $_SESSION['estimatef2'] : '-',
                         isset($_SESSION['estimateg2']) ? $_SESSION['estimateg2'] : '-',
                         isset($_SESSION['estimateh2']) ? $_SESSION['estimateh2'] : '-',
                         isset($_SESSION['estimatei2']) ? $_SESSION['estimatei2'] : '-',
                         isset($_SESSION['estimatej2']) ? $_SESSION['estimatej2'] : '-',
                         isset($_SESSION['estimatek2']) ? $_SESSION['estimatek2'] : '-',
                         isset($_SESSION['estimatel2']) ? $_SESSION['estimatel2'] : '-',
                         isset($_SESSION['estimatem2']) ? $_SESSION['estimatem2'] : '-',
                         isset($_SESSION['estimaten2']) ? $_SESSION['estimaten2'] : '-',
                         isset($_SESSION['estimateo2']) ? $_SESSION['estimateo2'] : '-',
                         isset($_SESSION['estimatep2']) ? $_SESSION['estimatep2'] : '-',
                         isset($_SESSION['estimateq2']) ? $_SESSION['estimateq2'] : '-',
                         isset($_SESSION['estimater2']) ? $_SESSION['estimater2'] : '-',
                         isset($_SESSION['estimates2']) ? $_SESSION['estimates2'] : '-',
                         isset($_SESSION['estimatet2']) ? $_SESSION['estimatet2'] : '-',
                         isset($_SESSION['estimateu2']) ? $_SESSION['estimateu2'] : '-',
                         isset($_SESSION['estimatev2']) ? $_SESSION['estimatev2'] : '-',
                         isset($_SESSION['estimatew2']) ? $_SESSION['estimatew2'] : '-',
                         isset($_SESSION['estimatex2']) ? $_SESSION['estimatex2'] : '-',
                         isset($_SESSION['estimatey2']) ? $_SESSION['estimatey2'] : '-',
                         isset($_SESSION['estimatez2']) ? $_SESSION['estimatez2'] : '-',
                         isset($_SESSION['estimateaa2']) ? $_SESSION['estimateaa2'] : '-',
                         isset($_SESSION['estimateab2']) ? $_SESSION['estimateab2'] : '-',
                         isset($_SESSION['estimateac2']) ? $_SESSION['estimateac2'] : '-',
                         isset($_SESSION['estimatead2']) ? $_SESSION['estimatead2'] : '-',
                         isset($_SESSION['estimateae2']) ? $_SESSION['estimateae2'] : '-',
                         isset($_SESSION['estimateaf2']) ? $_SESSION['estimateaf2'] : '-',
                         isset($_SESSION['estimateag2']) ? $_SESSION['estimateag2'] : '-',
                         isset($_SESSION['estimateah2']) ? $_SESSION['estimateah2'] : '-']);
    ...
    $svst14 = $svsi14 + $svsk14 + $svsm14 + $svso14 + $svsq14 + $svss14;
    $svst15 = $svsi15 + $svsk15 + $svsm15 + $svso15 + $svsq15 + $svss15;
    $svst16 = $svsi16 + $svsk16 + $svsm16 + $svso16 + $svsq16 + $svss16;
    $svst17 = $svsi17 + $svsk17 + $svsm17 + $svso17 + $svsq17 + $svss17;
...
<body>
    <div class="section">
        ...
        <tr style="background: #48494B;color:white;font-weight : bold;">
        ...
        <tr class="svsTableDataOne">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">2</td> -->
            <td style="background: #48494B;color:white;">Price</td>
            <td></td>
            <td><input type="text" name = "svsc2" readonly value="<?php if(isset($svsc2)){ echo $svsc2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svse2" readonly value="<?php if(isset($svse2)){ echo $svse2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsg2" readonly value="<?php if(isset($svsg2)){ echo $svsg2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsi2" readonly value="<?php if(isset($svsi2)){ echo $svsi2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsk2" readonly value="<?php if(isset($svsk2)){ echo $svsk2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsm2" readonly value="<?php if(isset($svsm2)){ echo $svsm2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svso2" readonly value="<?php if(isset($svso2)){ echo $svso2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsq2" readonly value="<?php if(isset($svsq2)){ echo $svsq2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svss2" readonly value="<?php if(isset($svss2)){ echo $svss2;} ?>"></td>
            <td></td>
            <td></td>
            <td><input type="text" name = "svsv2" readonly value="<?php if(isset($svsv2)){ echo $svsv2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsx2" readonly value="<?php if(isset($svsx2)){ echo $svsx2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsz2" readonly value="<?php if(isset($svsz2)){ echo $svsz2;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsab2" readonly value="<?php if(isset($svsab2)){ echo $svsab2 ;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsad2" readonly value="<?php if(isset($svsad2)){ echo $svsad2 ;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsaf2" readonly value="<?php if(isset($svsaf2)){ echo $svsaf2 ;} ?>"></td>
            <td></td>
            <td></td>
            <td><input type="text" name = "svsai2" readonly value="<?php if(isset($svsai2)){ echo $svsai2;}?>"></td>
        </tr>
        <tr class="svsTableDataOne">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">3</td> -->
            <td style="background: #48494B;color:white;">Sub/Manufacture name</td>
            <td></td>
            <td><input type="text" name = "svsc3" readonly value="<?php if(isset($svsc3)){ echo $svsc3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svse3" readonly value="<?php if(isset($svse3)){ echo $svse3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsg3" readonly value="<?php if(isset($svsg3)){ echo $svsg3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsi3" readonly value="<?php if(isset($svsi3)){ echo $svsi3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsk3" readonly value="<?php if(isset($svsk3)){ echo $svsk3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsm3" readonly value="<?php if(isset($svsm3)){ echo $svsm3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svso3" readonly value="<?php if(isset($svso3)){ echo $svso3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsq3" readonly value="<?php if(isset($svsq3)){ echo $svsq3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svss3" readonly value="<?php if(isset($svss3)){ echo $svss3;} ?>"></td>
            <td></td>
            <td></td>
            <td><input type="text" name = "svsv3" readonly value="<?php if(isset($svsv3)){ echo $svsv3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsx3" readonly value="<?php if(isset($svsx3)){ echo $svsx3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsz3" readonly value="<?php if(isset($svsz3)){ echo $svsz3;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsab3" readonly value="<?php if(isset($svsab3)){ echo $svsab3 ;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsad3" readonly value="<?php if(isset($svsad3)){ echo $svsad3 ;} ?>"></td>
            <td></td>
            <td><input type="text" name = "svsaf3" readonly value="<?php if(isset($svsaf3)){ echo $svsaf3 ;} ?>"></td>
            <td></td>
            <td></td>
            <td><input type="text" name = "svsai3" readonly value="<?php if(isset($svsai2)){ echo $svsai2 ;} ?>"></td>
        </tr>
        <tr class="svsTableDataOne">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">4</td> -->
            <td style="background: #48494B;color:white;"></td>
            <td></td>
            ...
            <td></td>
            <td><input type="text" name="svsaf4" id="" readonly value="<?php if(isset($svsaf4)){ echo $svsaf4 ;} ?>"></td>
            <td></td>
            <td></td>
            <td><b>Total</b></td>
        </tr>
        <tr class="svsTableDataOne">
            ...
            <td style="background: #48494B;color:white;">Spec 1</td>
            <td></td>
        ...
        <tr class="svsTableDataOne">
            ...
            <td style="background: #48494B;color:white;">Spec 2</td>
            <td></td>
        ...
        <tr class="svsTableDataOne">
            ...
            <td style="background: #48494B;color:white;">Spec 3</td>
            <td></td>
        ...
        <tr class="svsTableDataOne">
            ...
            <td style="background: #48494B;color:white;">Spec 4</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr class="svsDataFooter">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">10</td> -->
            <td><input type="text" name="svsa10" id="" readonly value="<?php if(isset($svsa10)){ echo $svsa10 ;} ?>"></td>
            <td><input type="text" name="svsb10" id="" value="<?php if(isset($_REQUEST['svsb10'])){ echo $_REQUEST['svsb10'] ;} ?>"></td>
            <td><input type="text" name="svsc10" id="" readonly value="<?php if(isset($svsc10)){ echo $svsc10 ;} ?>"></td>
            ...
            <td><input type="text" name="svsaa10" id="" value="<?php if(isset($_REQUEST['svsaa10'])){ echo $_REQUEST['svsaa10'] ;} ?>"></td>
            <td><input type="text" name="svsab10" id="" value="<?php if(isset($_REQUEST['svsab10'])){ echo $_REQUEST['svsab10'] ;} ?>"></td>
            <td><input type="text" name="svsac10" id="" value="<?php if(isset($_REQUEST['svsac10'])){ echo $_REQUEST['svsac10'] ;} ?>"></td>
            <td><input type="text" name="svsad10" id="" value="<?php if(isset($_REQUEST['svsad10'])){ echo $_REQUEST['svsad10'] ;} ?>"></td>
            <td><input type="text" name="svsae10" id="" value="<?php if(isset($_REQUEST['svsae10'])){ echo $_REQUEST['svsae10'] ;} ?>"></td>
            <td><input type="text" name="svsaf10" id="" value="<?php if(isset($_REQUEST['svsaf10'])){ echo $_REQUEST['svsaf10'] ;} ?>"></td>
            <td><input type="text" name="svsag10" id="" value="<?php if(isset($_REQUEST['svsag10'])){ echo $_REQUEST['svsag10'] ;} ?>"></td>
            <td><input type="text" name="svsah10" id="" value="<?php if(isset($_REQUEST['svsah10'])){ echo $_REQUEST['svsah10'] ;} ?>"></td>
            <td><input type="text" name="svsai10" id="" value="<?php if(isset($_REQUEST['svsai10'])){ echo $_REQUEST['svsai10'] ;} ?>"></td>
        </tr>
        <tr class="svsDataFooter">
            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">11</td> -->
            <td><input type="text" name="svsa11" id="" readonly value="<?php if(isset($svsa11)){ echo $svsa11 ;} ?>"></td>
            <td><input type="text" name="svsb11" id="" value="<?php if(isset($_REQUEST['svsb11'])){ echo $_REQUEST['svsb11'] ;} ?>"></td>
            <td><input type="text" name="svsc11" id="" readonly value="<?php if(isset($svsc11)){ echo $svsc11 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa12" id="" readonly value="<?php if(isset($svsa12)){ echo $svsa12 ;} ?>"></td>
            <td><input type="text" name="svsb12" id="" value="<?php if(isset($_REQUEST['svsb12'])){ echo $_REQUEST['svsb12'] ;} ?>"></td>
            <td><input type="text" name="svsc12" id="" readonly value="<?php if(isset($svsc12)){ echo $svsc12 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa14" id="" readonly value="<?php if(isset($svsa14)){ echo $svsa14 ;} ?>"></td>
            ...
            <td><input type="text" name="svsi14" id="" readonly value="<?php if(isset($svsi14)){ echo $svsi14 ;} ?>"></td>
            <td><input type="text" name="svsj14" id="" value="<?php if(isset($_REQUEST['svsj14'])){ echo $_REQUEST['svsj14'] ;} ?>"></td>
            <td><input type="text" name="svsk14" id="" readonly value="<?php if(isset($svsk14)){ echo $svsk14 ;} ?>"></td>
            <td><input type="text" name="svsl14" id="" value="<?php if(isset($_REQUEST['svsl14'])){ echo $_REQUEST['svsl14'] ;} ?>"></td>
            <td><input type="text" name="svsm14" id="" readonly value="<?php if(isset($svsm14)){ echo $svsm14 ;} ?>"></td>
            <td><input type="text" name="svsn14" id="" value="<?php if(isset($_REQUEST['svsn14'])){ echo $_REQUEST['svsn14'] ;} ?>"></td>
            <td><input type="text" name="svso14" id="" readonly value="<?php if(isset($svso14)){ echo $svso14 ;} ?>"></td>
            <td><input type="text" name="svsp14" id="" value="<?php if(isset($_REQUEST['svsp14'])){ echo $_REQUEST['svsp14'] ;} ?>"></td>
            <td><input type="text" name="svsq14" id="" readonly value="<?php if(isset($svsq14)){ echo $svsq14 ;} ?>"></td>
            <td><input type="text" name="svsr14" id="" value="<?php if(isset($_REQUEST['svsr14'])){ echo $_REQUEST['svsr14'] ;} ?>"></td>
            <td><input type="text" name="svss14" id="" readonly value="<?php if(isset($svss14)){ echo $svss14 ;} ?>"></td>
            <td><input type="text" name="svst14" id="" readonly value="<?php if(isset($svst14)){ echo $svst14 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa15" id="" readonly value="<?php if(isset($svsa15)){ echo $svsa15 ;} ?>"></td>
            ...
            <td><input type="text" name="svsi15" id="" readonly value="<?php if(isset($svsi15)){ echo $svsi15 ;} ?>"></td>
            <td><input type="text" name="svsj15" id="" value="<?php if(isset($_REQUEST['svsj15'])){ echo $_REQUEST['svsj15'] ;} ?>"></td>
            <td><input type="text" name="svsk15" id="" readonly value="<?php if(isset($svsk15)){ echo $svsk15 ;} ?>"></td>
            <td><input type="text" name="svsl15" id="" value="<?php if(isset($_REQUEST['svsl15'])){ echo $_REQUEST['svsl15'] ;} ?>"></td>
            <td><input type="text" name="svsm15" id="" readonly value="<?php if(isset($svsm15)){ echo $svsm15 ;} ?>"></td>
            <td><input type="text" name="svsn15" id="" value="<?php if(isset($_REQUEST['svsn15'])){ echo $_REQUEST['svsn15'] ;} ?>"></td>
            <td><input type="text" name="svso15" id="" readonly value="<?php if(isset($svso15)){ echo $svso15 ;} ?>"></td>
            <td><input type="text" name="svsp15" id="" value="<?php if(isset($_REQUEST['svsp15'])){ echo $_REQUEST['svsp15'] ;} ?>"></td>
            <td><input type="text" name="svsq15" id="" readonly value="<?php if(isset($svsq15)){ echo $svsq15 ;} ?>"></td>
            <td><input type="text" name="svsr15" id="" value="<?php if(isset($_REQUEST['svsr15'])){ echo $_REQUEST['svsr15'] ;} ?>"></td>
            <td><input type="text" name="svss15" id="" readonly value="<?php if(isset($svss15)){ echo $svss15 ;} ?>"></td>
            <td><input type="text" name="svst15" id="" readonly value="<?php if(isset($svst15)){ echo $svst15 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa16" id="" readonly value="<?php if(isset($svsa16)){ echo $svsa16 ;} ?>"></td>
            ...
            <td><input type="text" name="svsi16" id="" readonly value="<?php if(isset($svsi16)){ echo $svsi16 ;} ?>"></td>
            <td><input type="text" name="svsj16" id="" value="<?php if(isset($_REQUEST['svsj16'])){ echo $_REQUEST['svsj16'] ;} ?>"></td>
            <td><input type="text" name="svsk16" id="" readonly value="<?php if(isset($svsk16)){ echo $svsk16 ;} ?>"></td>
            <td><input type="text" name="svsl16" id="" value="<?php if(isset($_REQUEST['svsl16'])){ echo $_REQUEST['svsl16'] ;} ?>"></td>
            <td><input type="text" name="svsm16" id="" readonly value="<?php if(isset($svsm16)){ echo $svsm16 ;} ?>"></td>
            <td><input type="text" name="svsn16" id="" value="<?php if(isset($_REQUEST['svsn16'])){ echo $_REQUEST['svsn16'] ;} ?>"></td>
            <td><input type="text" name="svso16" id="" readonly value="<?php if(isset($svso16)){ echo $svso16 ;} ?>"></td>
            <td><input type="text" name="svsp16" id="" value="<?php if(isset($_REQUEST['svsp16'])){ echo $_REQUEST['svsp16'] ;} ?>"></td>
            <td><input type="text" name="svsq16" id="" readonly value="<?php if(isset($svsq16)){ echo $svsq16 ;} ?>"></td>
            <td><input type="text" name="svsr16" id="" value="<?php if(isset($_REQUEST['svsr16'])){ echo $_REQUEST['svsr16'] ;} ?>"></td>
            <td><input type="text" name="svss16" id="" readonly value="<?php if(isset($svss16)){ echo $svss16 ;} ?>"></td>
            <td><input type="text" name="svst16" id="" readonly value="<?php if(isset($svst16)){ echo $svst16 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa17" id="" readonly value="<?php if(isset($svsa17)){ echo $svsa17 ;} ?>"></td>
            ...
            <td><input type="text" name="svsi17" id="" readonly value="<?php if(isset($svsi17)){ echo $svsi17 ;} ?>"></td>
            <td><input type="text" name="svsj17" id="" value="<?php if(isset($_REQUEST['svsj17'])){ echo $_REQUEST['svsj17'] ;} ?>"></td>
            <td><input type="text" name="svsk17" id="" readonly value="<?php if(isset($svsk17)){ echo $svsk17 ;} ?>"></td>
            <td><input type="text" name="svsl17" id="" value="<?php if(isset($_REQUEST['svsl17'])){ echo $_REQUEST['svsl17'] ;} ?>"></td>
            <td><input type="text" name="svsm17" id="" readonly value="<?php if(isset($svsm17)){ echo $svsm17 ;} ?>"></td>
            <td><input type="text" name="svsn17" id="" value="<?php if(isset($_REQUEST['svsn17'])){ echo $_REQUEST['svsn17'] ;} ?>"></td>
            <td><input type="text" name="svso17" id="" readonly value="<?php if(isset($svso17)){ echo $svso17 ;} ?>"></td>
            <td><input type="text" name="svsp17" id="" value="<?php if(isset($_REQUEST['svsp17'])){ echo $_REQUEST['svsp17'] ;} ?>"></td>
            <td><input type="text" name="svsq17" id="" readonly value="<?php if(isset($svsq17)){ echo $svsq17 ;} ?>"></td>
            <td><input type="text" name="svsr17" id="" value="<?php if(isset($_REQUEST['svsr17'])){ echo $_REQUEST['svsr17'] ;} ?>"></td>
            <td><input type="text" name="svss17" id="" readonly value="<?php if(isset($svss17)){ echo $svss17 ;} ?>"></td>
            <td><input type="text" name="svst17" id="" readonly value="<?php if(isset($svst17)){ echo $svst17 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa19" id="" readonly value="<?php if(isset($svsa19)){ echo $svsa19 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa20" id="" readonly value="<?php if(isset($svsa20)){ echo $svsa20 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa21" id="" readonly value="<?php if(isset($svsa21)){ echo $svsa21 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa22" id="" readonly value="<?php if(isset($svsa22)){ echo $svsa22 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa23" id="" readonly value="<?php if(isset($svsa23)){ echo $svsa23 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa24" id="" readonly value="<?php if(isset($svsa24)){ echo $svsa24 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa25" id="" readonly value="<?php if(isset($svsa25)){ echo $svsa25 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsa26" id="" readonly value="<?php if(isset($svsa26)){ echo $svsa26 ;} ?>"></td>
        ...
        <tr class="svsDataFooter">
            ...
            <td><input type="text" name="svsi27" id="" readonly value="<?php if(isset($svsi27)){ echo $svsi27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svsj27" id="" value="<?php if(isset($_REQUEST['svsj27'])){ echo $_REQUEST['svsj27'] ;} ?>"></td>
            <td><input type="text" name="svsk27" id="" readonly value="<?php if(isset($svsk27)){ echo $svsk27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svsl27" id="" value="<?php if(isset($_REQUEST['svsl27'])){ echo $_REQUEST['svsl27'] ;} ?>"></td>
            <td><input type="text" name="svsm27" id="" readonly value="<?php if(isset($svsm27)){ echo $svsm27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svsn27" id="" value="<?php if(isset($_REQUEST['svsn27'])){ echo $_REQUEST['svsn27'] ;} ?>"></td>
            <td><input type="text" name="svso27" id="" readonly value="<?php if(isset($svso27)){ echo $svso27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svsp27" id="" value="<?php if(isset($_REQUEST['svsp27'])){ echo $_REQUEST['svsp27'] ;} ?>"></td>
            <td><input type="text" name="svsq27" id="" readonly value="<?php if(isset($svsq27)){ echo $svsq27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svsr27" id="" value="<?php if(isset($_REQUEST['svsr27'])){ echo $_REQUEST['svsr27'] ;} ?>"></td>
            <td><input type="text" name="svss27" id="" readonly value="<?php if(isset($svss27)){ echo $svss27 ;} else{ echo 0 ;} ?>"></td>
            <td><input type="text" name="svst27" id="" readonly value="<?php if(isset($svst27)){ echo $svst27 ;} else{ echo 0 ;} ?>"></td>
