...
if (isset($_POST['mansubmit'])) {
    ...
    $mana10 = array_sum([
        floatval(isset($_SESSION['estimatei8']) ? $_SESSION['estimatei8'] : '-'),
    ...
    $mana19 = array_sum([
        floatval(isset($_SESSION['estimateh44']) ? $_SESSION['estimateh44'] : '-'),
...
<head>
    ...
    <style>
        .manHoursShopHoursData , .fieldHoursShopHoursData , .materialData, .factoryData {
            background: #ECECEC;
            box-shadow: 2px 4px 5px 4px #82868E;
        }

        .manHoursShopHoursData input , .fieldHoursShopHoursData input , .materialData input , .factoryData input{
            ...
            <center>
                <form action="" method="POST">
                    ...
                    <td>G</td>
                        ...
                        <tr>
                            <td style="text-align: center;position:sticky;left:14%; color:white;"></td>
                            <th style="background: #ECECEC;
box-shadow: 2px 4px 5px 4px #82868E;" colspan="4">Man Hours</th>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        ...
                        <tr style="background: #48494B;color : white;margin-top:2rem !important;">
                            <td style="text-align: center;position:sticky;left:0; background-color:white;"></td>
                        ...
                        <tr class="manHoursShopHoursData">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">5</td> -->
                            <td colspan="2"><input type="text" readonly name="mana5" id="" value="<?php if (isset($mana5)) {
                                echo $mana5;
                            } ?>"></td>
                        ...
                        <tr class="manHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana6" id="" value="<?php if (isset($mana6)) {
                                echo $mana6;
                            } ?>"></td>
                        ...
                        <tr class="manHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana7" id="" value="<?php if (isset($mana7)) {
                                echo $mana7;
                            } ?>"></td>
                        ...
                        <tr>
                            <!-- <td style="text-align: center;position:sticky;left:0; color:white;background-color:white;">8</td> -->
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr style="background: #48494B;color : white;">
                            <!-- <td style="text-align: center;position:sticky;left:0; color : white; background-color: white;">9</td> -->
                            <th colspan="4">Field Hours</th>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr class="fieldHoursShopHoursData">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">10</td> -->
                            <td colspan="2"><input type="text" readonly name="mana10" id="" value="<?php if (isset($mana10)) {
                                echo $mana10;
                            } ?>"></td>
                            <td colspan="2"></td>
                            <td></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana11" id="" value="<?php if (isset($mana11)) {
                                echo $mana11;
                            } ?>"></td>
                            <td colspan="2"></td>
                            <td></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana12" id="" value="<?php if (isset($mana12)) {
                                echo $mana12;
                            } ?>"></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana13" id="" value="<?php if (isset($mana13)) {
                                echo $mana13;
                            } ?>"></td>
                            <td colspan="2"></td>
                            <td></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana14" id="" value="<?php if (isset($mana14)) {
                                echo $mana14;
                            } ?>"></td>
                            <td colspan="2">Hours</td>
                            <td></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana15" id="" value="<?php if (isset($mana15)) {
                                echo $mana15;
                            } ?>"></td>
                            <td colspan="2">Contingency Hours</td>
                            <td></td>
                        ...
                        <tr class="fieldHoursShopHoursData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana16" id="" value="<?php if (isset($mana16)) {
                                echo $mana16;
                            } ?>"></td>
                        ...
                        <tr >
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;color : white;">17</td> -->
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr style="background: #48494B;color : white;">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;color : white;">18</td> -->
                        ...
                        <br>
                        <tr class="materialData">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">19</td> -->
                            <td colspan="2"><input type="text" readonly name="mana19" id="" value="<?php if (isset($mana19)) {
                                echo $mana19;
                            } ?>"></td>
                            <td colspan="2"></td>
                            <td></td>
                        ...
                        <tr class="materialData">
                            ...
                            <td colspan="2"><input type="text" readonly name="mana20" id="" value="<?php if (isset($mana20)) {
                                echo $mana20;
                            } ?>"></td>
                        ...
                        <tr style="background: #48494B;color : white;">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;color:white;">22</td> -->
                            <th colspan="4" name="mana22">LOG BID ESTIMATE ON DUCTWORK LABOR FABRICATION ONLY (NO FIELD)
                            </th>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr class="factoryData">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">23</td> -->
                            <td colspan="2"><input type="text" readonly name="mana23" class="custom-input" value="<?php if (isset($mana23)) {
                                echo $mana23;
                            } ?>"></td>
                            <td colspan="2"></td>
                            <td></td>
                            ...
                            <td><input type="text" name="mang23" class="custom-input" value="<?php if (isset($_REQUEST['mang23'])) {
                                echo $_REQUEST['mang23'];
                            } ?>"></td>
                        </tr>
                        <tr class="factoryData">
                            <!-- <td style="text-align: center;position:sticky;left:0; background-color:white;">24</td> -->
                            <td colspan="2"><input type="text" readonly name="mana24" id="custom-input" value="<?php if (isset($mana24)) {
                                echo $mana24;
                            } ?>"></td>
                    ...
                    <?php if (isset($_REQUEST['mansubmit'])) { ?>
                        <input type="submit" value="Download Man Hours" class="downloadexcel" name="do    wnloadexcel">
                    <?php } ?>
                </form>
            </center>
        </div>
