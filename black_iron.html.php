...
if(isset($_REQUEST['black_ironsubmit'])){
    ...
    // Column F
    $blackf11 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke11']) : 0;
    $blackf12 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke12']) : 0;
    $blackf13 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke13']) : 0;
    $blackf14 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke14']) : 0;
    $blackf15 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke15']) : 0;
    $blackf16 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke16']) : 0;
    $blackf17 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke17']) : 0;
    $blackf18 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke18']) : 0;
    $blackf19 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke19']) : 0;
    $blackf20 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke20']) : 0;
    $blackf21 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke21']) : 0;
    $blackf22 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke22']) : 0;
    $blackf23 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke23']) : 0;
    $blackf24 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke24']) : 0;
    $blackf25 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke25']) : 0;
    $blackf26 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke26']) : 0;
    $blackf27 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke27']) : 0;
    $blackf28 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke28']) : 0;
    $blackf29 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke29']) : 0;
    $blackf30 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke30']) : 0;
    $blackf31 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke31']) : 0;
    $blackf32 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke32']) : 0;
    $blackf33 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke33']) : 0;
    $blackf34 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke34']) : 0;
    $blackf35 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke35']) : 0;
    $blackf36 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke36']) : 0;
    $blackf37 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke37']) : 0;
    $blackf38 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke38']) : 0;
    $blackf39 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke39']) : 0;
    $blackf40 = (floatval($_REQUEST['blacki2']) == 2.7) ? 1 * floatval($_REQUEST['blacke40']) : 0;

    // Column G
    $blackg11 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke11']) : 0;
    $blackg12 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke12']) : 0;
    $blackg13 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke13']) : 0;
    $blackg14 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke14']) : 0;
    $blackg15 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke15']) : 0;
    $blackg16 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke16']) : 0;
    $blackg17 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke17']) : 0;
    $blackg18 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke18']) : 0;
    $blackg19 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke19']) : 0;
    $blackg20 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke20']) : 0;
    $blackg21 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke21']) : 0;
    $blackg22 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke22']) : 0;
    $blackg23 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke23']) : 0;
    $blackg24 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke24']) : 0;
    $blackg25 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke25']) : 0;
    $blackg26 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke26']) : 0;
    $blackg27 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke27']) : 0;
    $blackg28 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke28']) : 0;
    $blackg29 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke29']) : 0;
    $blackg30 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke30']) : 0;
    $blackg31 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke31']) : 0;
    $blackg32 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke32']) : 0;
    $blackg33 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke33']) : 0;
    $blackg34 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke34']) : 0;
    $blackg35 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke35']) : 0;
    $blackg36 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke36']) : 0;
    $blackg37 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke37']) : 0;
    $blackg38 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke38']) : 0;
    $blackg39 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke39']) : 0;
    $blackg40 = (floatval($_REQUEST['blacki2']) == 3.125) ? 1 * floatval($_REQUEST['blacke40']) : 0;
    ...
    $blacki6 = ($blackf5 * 3.85) * 1.03;
    $blacki5 = ($blackf5 * 1.15) * 1.07;

    // ROW 4
    $blacke4 = round((($blackf6 * 0.24) + $blackf6), 2);
    $blacke3 = round((($blacki5 * 0.24) + $blacki5), 2);

    $blacki4 = ($blacke3 * 3.85) * 1.03 * 1.25;
    $_SESSION['blacki4'] = $blacki4;


    // ROW 3
    $blacki3 = ((((($blacke3 * 1.15) * 1.1) * 1.1) * 1.1) * 1.1) * 1.07 * 2.5;
    ...
    $blacki41 = array_sum($blacki41array);
...
input[type="text"] {
    width: 100%;
    /* This makes the text input take 100% of the width of its parent (the td) */
    box-sizing: border-box;
    /* This includes padding and border in the element's total width */
}
</style>
        ...
        <form action="" method="POST">
            <table border="1" style="border-collapse:collapse;" class="table_1">
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Job name:</td>
                    <td><input type="text" name="blackc1" value="<?php if(isset($blackc1)){ echo $blackc1 ;} ?>"></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="text" name="blacke3"
                            value="<?php if(isset($blacke3)){ echo $blacke3 ;} else{ echo 0 ;} ?>"></td>
                    <td></td>
                    <td>Material Cost</td>
                    <td></td>
                    <td><input type="text" name="blacki3"
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="text" name="blacke4"
                            value="<?php if(isset($blacke4)){ echo $blacke4 ;} else{ echo 0 ;} ?>"></td>
                    <td></td>
                    <td>Labor Cost</td>
                    <td></td>
                    <td><input type="text" name="blacki4"
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="text" name="blacke7"
                ...
                <tr style="position: sticky; top:9%; background-color:white;">
